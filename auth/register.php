...
if (isset($_POST["submit"])) {
    ...
    if (mysqli_num_rows($res_e) > 0) {
        ...
        if ($password == $c_password) {
            ...
            $sql = "INSERT INTO clients (first_name, last_name, email, country, username, password, referrer_code, sQuestion, sAnswer, avatar, verification_code) 
        ...
        <div class="card shadow-lg">
            <div class="card-body">
                ...
                <form class="user" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select id="country" name="country" class="form-control">
                            <option value="<?php if (!empty($country)) {echo $_POST['country'];}?>">
                                Select your Country
                            </option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter referral"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-black">Security Question</label>
                                ...
                                <span class="error"><?php echo $sQuestionErr; ?></span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-black">Security Answer</label>
                                <input type="text" name="sAnswer" placeholder="Enter Security Answer" class="form-control">
                                <span class="error"><?php echo $sAnswerErr; ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Submit Button -->
                    <div class="form-group">
                        <input type="hidden" name="referrer_code" value="{{ !empty(request('ref')) ? request('ref') : '' }}">
                        <button name="submit" type="submit" class="btn btn-primary-custom btn-block">Create Account</button>
                    </div>
                </form>
                ...
                <div class="text-center text-black">
                    Already have an account? <a class="font-weight-bold small" href="login.php" style="color:#1b21d1;">Login!</a>
                </div>
            </div>
        </div>
    </div>
