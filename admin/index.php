        ...
        <div class="row">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <img height="100px" width="100px"
                        src="user-area/address/<?php echo $getdetailsBTC['qrcode']; ?>">
                </div>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <img height="100px" width="100px"
                        src="user-area/address/<?php echo $getdetailsETH['qrcode']; ?>">
                </div>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <img height="100px" width="100px"
                        src="user-area/address/<?php echo $getdetailsUSDT['qrcode']; ?>">
                </div>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <img height="100px" width="100px"
                        src="user-area/address/<?php echo $getdetailsBNB['qrcode']; ?>">
                </div>
