...
<body style="background-color: #1e2024; padding: 45px;">
    <div>
        <img style="position:relative; left:35%;" src="https://Octavat.com/images/logooct.png">
        <h3 style="color: black;">Mail From support@Octavat.com - Deposit Added</h3>
    </div>
    <div style="color: #ffff;"><hr/>
        ...
        <a style="background-color:#060c39;color:#ffff; padding:15px; text-decoration:none;border-radius: 10px;font-size: 20px;" href="https://Octavat.com/dash/auth/login.php" class="btn btn primary">Sign in</a>
