    ...
    <header class="sticky top-0 z-50 bg-[#111111] backdrop-blur-md bg-opacity-90 border-b border-gray-800">
        <nav class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-4">
                ...
                <a href="login.php" class="bg-gray-800 rounded-full w-8 h-8 flex items-center justify-center text-gray-400 hover:bg-gray-700 transition-colors">
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu" class="hidden md:hidden px-4 py-4 bg-[#111111] transition-all duration-300 ease-in-out">
