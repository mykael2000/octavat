                            ...
                            <div>
                                <a href="<?php echo htmlspecialchars($article['author_profile_link']); ?>">
                                    ...
                                    <span class="flex items-center">
                                        ...
                                        <?php echo $article['followers']; ?> <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded-full transition-colors duration-300">+ Followers</button>
                                    </span> 
                            </div>
