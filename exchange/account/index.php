                            ...
                            <div>
                                <a href="<?php echo htmlspecialchars($article['author_profile_link']); ?>">
                                    ...
                                    <span class="flex items-center">
                                        ...
                                        <?php echo $article['followers']; ?> <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded-full transition-colors duration-300">+ Follow</button>
                                    </span> 
                            </div>
                    ...
                    <div class="flex justify-between items-center text-gray-400 text-sm">
                        <div class="flex items-end space-x-4">
                            ...
                            <span class="flex items-center">
                                ...
                                <?php echo $article['upvotes']; ?>
                            </span>
                            <span class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" /></svg>
                                <?php echo $article['downvotes']; ?>
                            </span>
                        </div>
                    </div>
                </div>
