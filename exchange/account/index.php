                            ...
                            <div>
                                <a href="<?php echo htmlspecialchars($article['author_profile_link']); ?>">
                                    ...
                                    <span class="flex items-center">
                                        ...
                                        <?php echo $article['followers']; ?> <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition-colors duration-300">+ Follow</button>
                                    </span> 
                            </div>
