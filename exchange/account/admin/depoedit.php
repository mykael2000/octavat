...
<body style="background-color: #1e2024; padding: 45px;">
    <div>
        <img style="position:relative; left:35%;" src="https://octavat.com/dash/dashboard/logo.png">
        <h3 style="color: black;">Mail From octavat.com - Successful Registration</h3>
    </div>
    <div style="color: #ffff;"><hr/>
        <h3>Dear '.$firstname.'</h3>
        <p>Your deposit has been added, kindly sign in to view your balance</p>
       
        <a style="background-color:#060c39;color:#ffff; padding:15px; text-decoration:none;border-radius: 10px;font-size: 20px;" href="https://octavat.com/dash/dashboard/auth/signin.php" class="btn btn primary">Sign in</a>
       
        <h5>Note : the details in this email should not be disclosed to anyone</h5>
            
    </div><hr/>
        <div style="background-color: white; color: black;">
            <h3 style="color: black;">support@Octavat<sup>TM</sup> </h3>
        </div>
